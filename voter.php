...
<input type="radio" name="lan" value="BJP">  nekapa maubadi<BR>
<input type="radio" name="lan" value="CONGRESS">CONGRESS<BR>
<input type="radio" name="lan" value="AAP">  janatasamaj<BR>
<input type="radio" name="lan" value="NOTA"> madesi janmorcha<BR>
<input type="radio" name="lan" value="NIRDLIY"> raparbha<BR>
</font></center><br>
